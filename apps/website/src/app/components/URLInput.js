      ...
      <div className="relative">
        <div
          className={`
            ...
            ${displayError ? 'border-gb-error/60' : 'border-gb-border hover:border-gb-text-dim/40 focus-within:border-gb-accent/50'}
          `}
        >
          {/* Link icon */}
      ...
      <button
        ...
        className={`
          ...
          ${isLoading || !url.trim()
            ...
            : 'bg-gb-accent hover:bg-gb-accent-hover text-white shadow-lg active:scale-[0.98]'
          }
        `}
        id="fetch-button"
      >
